...
<div class="flex flex-col justify-center items-center gap-10 sm:gap-12 lg:gap-16">
	<h1
		class="text-5xl sm:text-7xl lg:text-8xl text-[var(--colour-primary)]
		drop-shadow-2xl font-medium text-center"
	>
		I'm <span class="text-[var(--colour-secondary)]">Conor Egan</span>
	</h1>
	<h2
		class="text-2xl sm:text-4xl lg:text-5xl lg:leading-tight text-[var(--colour-primary)]
		drop-shadow-2xl font-normal text-center max-w-sm sm:max-w-xl lg:max-w-3xl"
	>
